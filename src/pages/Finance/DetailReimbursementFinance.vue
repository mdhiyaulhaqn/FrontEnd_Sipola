    ...
    <div class="row">
        <div class = "col-12">
            ...
            <card class="col">
                ...
                <b-row>
                    <div class="grup-status">
                      <div class="col-lg-10 col-sm-10 col-12 " >Status</div>
