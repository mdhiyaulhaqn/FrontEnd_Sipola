...
export default {
    ...
    methods:{
        ...
        downloadReport:function(){
            ...
            doc.setFontStyle("bold")
            doc.text("Terms of Delivery", startX, startY+64)
            doc.setFontStyle("normal")
            doc.text(": "+ termsOfDelivery, startX+35, startY+64)
            doc.setFontStyle("bold")
            doc.text("Payment Terms", startX, startY+69)
            doc.setFontStyle("normal")
            doc.text(": "+ paymentTerms, startX+35, startY+69)
            ...
            doc.setFontStyle("bold")
            doc.text("Currency", 140, startY+64)
            doc.setFontStyle("normal")
            doc.text("IDR", 140, startY+69)
            ...
            // price
            var subTotal = this.invoice.sub_total_price.toLocaleString('id-ID') + ",00"
            var VAT = this.invoice.price_vat.toLocaleString('id-ID') + ",00"
            var grandTotal = this.invoice.grand_total_price.toLocaleString('id-ID') + ",00"
