                            ...
                            <div class="tabel-service">
                                <div slot="raw-content" class="table-responsive" style="font-size:12px">
                                    ...
                                    <b-row align-content="right">
                                        ...
                                        <div class = "col-md-3 col-6">
                                            Rp{{formatPrice(this.purchaseOrder.total_all_price)}}
                                        </div>
                                    </b-row>
                                </div>
                            </div>
...
export default {
    data() {
        return {
            ...
            fields: [
                ...
                {key: 'unitOfMeasurement', label: 'UOM', sortable: true},
                {key: 'quantity', label: 'Quantity', sortable: true},
                {key: 'pricePerUnit', label: 'Unit Price (IDR)', sortable: true, formatter: value =>{
    ...
    methods:{
        ...
        computePrice(){
            ...
            this.purchaseOrder.total_all_price = this.purchaseOrder.sub_total_price + this.purchaseOrder.price_ppn;
        },
        ...
        downloadReport:function(){
            ...
            var column = [
                ...
                {title: 'UOM', dataKey: 'unitOfMeasurement'},
