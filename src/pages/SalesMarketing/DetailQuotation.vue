        ...
        <b-modal
            ...
            <template v-slot:default>
                ...
                <b-row>
                    ...
                    <b-col class="col-10">
                        <p id="modal-message"> The system is downloading quotation no. {{quotation.noQuotation}}</p>
                    </b-col>
                </b-row>
                </div>
            </template>
...
export default {
    data() {
        return {
            ...
            fields: [
                ...
                {key: 'quantity_new', label: 'Quantity', sortable: true},
                {key: 'harga_new', label: 'Unit Price(IDR)', formatter: value => {
    ...
    methods:{
        ...
        downloadReport:function(){
            ...
            doc.setFontSize(16);
            doc.text('Quotation', startX, startY+25);
            ...
            doc.setFontSize(10);
            doc.text('Kepada Yth,', startX, startY+55);
            doc.text(companyName, startX, startY+60);
            doc.text(companyAddress, startX, startY+65);

            doc.text('Bersama ini kami sampaikan penawaran harga sebagai berikut', startX, startY+80);
            ...
            var columns = [
                ...
                {title: "Price/ unit (IDR)", dataKey: "harga_new"},
            ...
            doc.setFontStyle("bold");
            var totalharga = 'Rp '+this.quotation.total_harga_semua.toLocaleString('de-DE') + ',00';
            doc.text('Total : ', startX, finalY+10);
            doc.setFontStyle("light");
            doc.text(totalharga, startX+15, finalY+10);
